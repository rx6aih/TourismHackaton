...
using Tourism.Dotnet.Admin.DAL.Interfaces;

namespace Tourism.Dotnet.Admin.DAL.Implementations;

public class Repository<T>(AdminDbContext context) : IRepository<T>
    where T : class
{
